...
public class Stream_01_Test {
	...
	public void test_stream_allMatch() throws Exception {
		...
		// TODO valider que toutes les pizza à un prix >= 1300
		Boolean result1 = pizzas.stream().allMatch(p -> p.getPrice() >= 1300);

		// TODO valider que toutes les pizza pizza à un prix >= 2000
		Boolean result2 = pizzas.stream().allMatch(p -> p.getPrice() >= 2000);
