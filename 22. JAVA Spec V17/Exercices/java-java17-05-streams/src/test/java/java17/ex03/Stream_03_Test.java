...
public class Stream_03_Test {
	...
	public void test_max() throws Exception {
		...
		Optional<Order> result = orders.stream().max(Comparator.comparingDouble(p -> p.getPrice()));
	...
	public void test_min() throws Exception {
		...
		Optional<Order> result = orders.stream().min(Comparator.comparingDouble(p -> p.getPrice()));;
	...
	public void test_flatMap() throws Exception {
		...
		List<Pizza> result = orders.stream().flatMap(p -> p.getPizzas().stream()).toList();
	...
	public void test_flatMap_distinct() throws Exception {
		...
		List<Pizza> result = orders.stream().flatMap(p -> p.getPizzas().stream()).distinct().toList();
